---
title: Creating My Personal Website/Blog with Jekyll, Netlify, and Github Actions
author: Emmanuel Tan
date: 2025-05-27
layout: post
---
...
In this post I go through the steps taken to build my own website/blog, my experience through the process, and what I learned and would do differently. 
...
There are lots more options for themes, some of which are paid and others that are free. Here's a handy place to browse them.

![Jekyll Themes Site](../../assets/images/personal-website-jekyll-themes.png){: width="80%"}

*[Jekyll Themes Site](https://jekyllthemes.io/)*
...
The [Jekyll website](https://jekyllrb.com/docs/installation/) walks you through installing Ruby and Jekyll nicely. This isn't my area of expertise so I won't comment too much, and the process went smoothly for me. I believe `bundler` is required as well, which I installed with `gem intall bundler`. 

After Jekyll is installed, I needed to fork the repo of the theme I wanted and then download it to my computer (ie `git clone https://github.com/sighingnow/jekyll-gitbook.git` except the link is replaced with your forked repo).
...
![Screenshot of Deploy Workflow](../../assets/images/personal-website-github-actions.png){: width="80%"}

*Here's what the workflow should look like if it successfully runs*
...
Some takeaways:
- Struggled with this project for a while because I wanted to do something really cool and fancy but that gave me more barriers: easy is better
- It can be really easy and really quick if you use the right tools
- CI/CD takes a bit of set up but makes life easy in the future

What I might do different
- This theme is not my favorite, but that's easy enough to change. But again, to get it out there, I just needed to make it first before I made it better.
